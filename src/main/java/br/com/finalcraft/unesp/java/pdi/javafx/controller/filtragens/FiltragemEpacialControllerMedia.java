...
public class FiltragemEpacialControllerMedia {

    private static FiltragemEpacialControllerMedia instance;
    private Stage stage;
    ...
    public static void show(){
        if (instance.firstRun){
            Scene newSceneWindow = new Scene(MyFXMLs.filtragem_espacial_media);
    ...
    void onAplicarFiltragem(ActionEvent event) {
        try {
            ...
            MainController.rightImage = MainController.rightImage.filtragemEspacialMedia(coef, pesos);
